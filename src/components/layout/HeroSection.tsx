...
function HeroSection() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <nav className={`relative z-10 flex items-center justify-between w-full px-4 sm:px-6 py-6 text-white transition-all duration-300 ${isServicesOpen ? 'bg-[rgba(75,38,21,1)]' : ''}`}>
        ...
        <ul className="hidden md:flex items-center space-x-8 absolute left-1/2 transform -translate-x-1/2 -2">
          ...
          <li>
            ...
            <Link href="#" className={`"hover:text-white/80 text-sm" ${isRTL ? 'ml-5' : 'ml-0'}`}>
              {t("nav.contact")}
            </Link>
          </li>
        </ul>
        ...
        {/* Right Actions */}
        <div className={`flex items-center space-x-4 ${isRTL? "mr-auto" : "ml-auto"} gap-4`}>
          <LanguageSwitcher />
      ...
      {/* Hero Content */}
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 mt-8 sm:mt-10 md:mt-0 pb-16 sm:pb-32 md:mt-28 md:pb-40">
